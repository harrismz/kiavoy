...
const fetchReligion = async () => {
    try {
        const religionResponse = await axios.get(baseUrl + '/api/religion');
...
const updateKecamatan = async () => {
    try {
        const selectedKelurahan = await axios.get(baseUrl + '/api/kecamatan/' + formIdentitasIbu.kelurahan);
...
export default {
    setup() {
        ...
        //     try {
        // const selectedKecamatan = await axios.get('http:localhost:8000/api/kabupaten/' + formIdentitasIbu.kecamatan);
        ...
        // try {
        // const selectedKabupaten = await axios.get('http:localhost:8000/api/provinsi/' + formIdentitasIbu.kabupaten);
